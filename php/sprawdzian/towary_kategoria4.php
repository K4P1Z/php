...
<body>
    ...
    <h2>Towary z kategorii 4</h2>
    <div class="list">
        <?php
        $all_records = $conn->query("SELECT bazasklepik.ID, bazasklepik.CENA, bazasklepik.NAZWA, bazasklepik.KATEGORIA FROM bazasklepik WHERE bazasklepik.KATEGORIA = 4;");
    ...
    <div class="numberofrecords">
        <?php
        $counter_records = $conn->query("SELECT COUNT(bazasklepik.ID) as 'ile' FROM bazasklepik WHERE KATEGORIA = 4;");
